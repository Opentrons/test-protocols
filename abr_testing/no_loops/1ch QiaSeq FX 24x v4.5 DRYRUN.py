...
metadata = {
    'protocolName': '1ch QiaSeq FX 24x v4.5.py DRYRUN',
        ...
        if STEP_CLEANUP_1 == 1:
            ...
            if COLUMNS == 3:
                ...
                for loop, X in enumerate(column_2_list):
                    ...
                    p1000.move_to(sample_plate_1[column_1_list[loop]].bottom(z=.6))
        ...
        if STEP_CLEANUP_2 == 1:
            ...
            if COLUMNS == 3:
                ...
                for loop, X in enumerate(column_3_list):
                    ...
                    protocol.comment('--> Transferring Supernatant')
                    p50.move_to(sample_plate_1[column_2_list[loop]].bottom(z=.6))
