...
metadata = {
    'protocolName': 'Zymo Magbead RNA Extraction: Cells- ABR',
...
Slot C3: Nest 12 well 15 ml Reservoir
...
Wells 1-6 - 9,500 ul
Wells 7-9 - 10,000 ul
Wells 10-12 - 9,500 ul

Reservoir 3:
Wells 1-12 - 10,900 ul 
"""
...
def run(ctx):
    ...
    elute(elution_vol)
    ctx.comment('Tips used: '+str(dc))
    ctx.comment('Tips used: '+str(dcs))