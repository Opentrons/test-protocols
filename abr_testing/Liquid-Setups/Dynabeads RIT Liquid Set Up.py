...
def run(protocol: protocol_api.ProtocolContext):
    ...
    reservoir_wash      = protocol.load_labware('nest_12_reservoir_15ml',location = 'D2') # Reservoir
    sample_plate        = protocol.load_labware('nest_96_wellplate_2ml_deep', location = 'D3')
