...
############################################################################################################################################
    ...
    if STEP_FRERAT == 1:
        ...
        p1000.aspirate(FRERATVol, FRERAT.bottom(z=.6))
        p1000.dispense(FRERATVol, sample_plate_1['A1'].bottom(z=.6))
        p1000.move_to(sample_plate_1['A1'].bottom(z=.6))
    ...
    if STEP_LIG == 1:
        ...
        p1000.dispense(LIGVol, sample_plate_1['A1'].bottom(z=.6), rate=0.25)
        p1000.move_to(sample_plate_1['A1'].bottom(z=.6))
    ...
    if STEP_POSTPCR == 1:
        ...
        p1000.aspirate(RemoveSup-100, rate=0.25)
        protocol.delay(minutes=0.1)
        p1000.move_to(sample_plate_2['A1'].bottom(z=.6))
        p1000.aspirate(100, rate=0.25)
        p1000.default_speed = 5
