...
def run(protocol: protocol_api.ProtocolContext):
    ...
    ### TIP RACKS ###
    tiprack_200_1       = protocol.load_labware('opentrons_flex_96_tiprack_200ul', 'B1')
    tiprack_200_2       = protocol.load_labware('opentrons_flex_96_tiprack_200ul', 'B2')
    tiprack_200_3       = protocol.load_labware('opentrons_flex_96_tiprack_200ul', 'C2')
    ...
    # Magnetic Block
    mag_block           = protocol.load_module('magneticBlockV1', 'D4')
    thermocycler        = protocol.load_module('thermocycler module gen2')
    sample_plate_1      = thermocycler.load_labware('nest_96_wellplate_100ul_pcr_full_skirt')
    # Temperature Module
    temp_block          = protocol.load_module('temperature module gen2', 'B3')
