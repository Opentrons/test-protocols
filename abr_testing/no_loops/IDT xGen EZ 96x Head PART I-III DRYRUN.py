...
############################################################################################################################################
    ...
    if STEP_FRERAT == 1:
        ...
        p1000.aspirate(FRERATVol, FRERAT.bottom(z=0.5))
        p1000.dispense(FRERATVol, sample_plate_1['A1'].bottom(z=0.5))
    ...
    if STEP_LIG == 1:
        ...
        p1000.dispense(LIGVol, sample_plate_1['A1'].bottom(z=0.5), rate=0.25)
        p1000.move_to(sample_plate_1['A1'].bottom(z=0.5))
