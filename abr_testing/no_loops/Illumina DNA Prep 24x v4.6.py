...
metadata = {
    'protocolName': 'Illumina DNA Prep 24x v4.6',
    ...
    for loop in range(RUN):
        ...
        if STEP_TAG == 1:
            ...
            for loop, X in enumerate(column_1_list):
                tipcheck()
                p50.pick_up_tip()
                p50.aspirate(TAGSTOPVol, TAGSTOP.bottom(z=1))
                p50.dispense(TAGSTOPVol, sample_plate_1[X].bottom(z=1))
        ...
        if STEP_CLEANUP == 1:
            ...
            for loop, X in enumerate(column_1_list):
                ...
                p50.aspirate(H20Vol, H20.bottom(z=1), rate=1)
                p50.dispense(H20Vol, sample_plate_1[column_2_list[loop]].bottom(z=1))
                ...
                p50.aspirate(SampleVol, sample_plate_1[column_1_list[loop]].bottom(z=1), rate=1)
                p50.dispense(SampleVol, sample_plate_1[column_2_list[loop]].bottom(z=1))
