...
# # """
    ...
    p50 = ctx.load_instrument(
        "flex_1channel_50", mount_pos_50ul, tip_racks=tiprack_50)
    ...
    for row in csv_lines:
        ...
        # p50.blow_out()
    p50.drop_tip() if trash_tip else p50.return_tip()
    ...
    for row in csv_lines:
        ...
        p50.drop_tip() if trash_tip else p50.return_tip() if real_mode else p50.return_tip()
        p50.configure_for_volume(50)
