...
############################################################################################################################################
    ...
    if STEP_CAPTURE == 1:
        ...
        PanelVol    = 10
        p50.pick_up_tip()
        p50.aspirate(PanelVol, Panel.bottom(.5))
        p50.dispense(PanelVol, sample_plate_1[sample_well].bottom(.5))
        p50.return_tip()
        ...
        EHB2MixVol = 90
        p1000.pick_up_tip()
        p1000.aspirate(EHB2Vol, EHB2.bottom(.5))
        p1000.dispense(EHB2Vol, sample_plate_1[sample_well].bottom(.5))
