...
metadata = {
    'protocolName': 'OT-3 Omega HDQ DNA Extraction: HeLa Cells',
...
def run(ctx):
    ...
    tips1000 = ctx.load_labware('opentrons_ot3_96_tiprack_1000ul', '5')
    tips1001 = ctx.load_labware('opentrons_ot3_96_tiprack_1000ul', '6')
    tips1002 = ctx.load_labware('opentrons_ot3_96_tiprack_1000ul', '7')
