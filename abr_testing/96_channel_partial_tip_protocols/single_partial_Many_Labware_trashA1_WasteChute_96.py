...
metadata = {
    "protocolName": "single_partial_many_labware_trashA1_WasteChute"
}
requirements = {    
    "robotType": "Flex",
    "apiLevel": "2.16",
...
def asp_disp(pipette, lw1_list):
    for i in lw1_list:
        pipette.aspirate(50, i.wells()[0].bottom(z=0.5))
        pipette.dispense(50, i.wells()[0].bottom(z=0.5))
...
def run(protocol_context: protocol_api.ProtocolContext):
    ...
    tiprack1000_1 = adapter1.load_labware("opentrons_flex_96_tiprack_1000ul")
    tiprack1000_2 = adapter2.load_labware("opentrons_flex_96_tiprack_1000ul")
    tiprack1000_3 = protocol_context.load_labware("opentrons_flex_96_tiprack_1000ul", "B2")

    #load the 200 ul tipracks
    tiprack200_1 = protocol_context.load_labware("opentrons_flex_96_tiprack_200ul", "B3")
    tiprack200_2 = protocol_context.load_labware("opentrons_flex_96_tiprack_200ul", "A4")
    tiprack200_3 = protocol_context.load_labware("opentrons_flex_96_tiprack_200ul", "B4")
    ...
    # list of plates for 1000 ul and 200 ul tips
    plates_1000and200 = [armadillo_96, nest_12, nest_96, nest_res]
    ...
    asp_disp(pipette, plates_1000and200)
    pipette.drop_tip()
