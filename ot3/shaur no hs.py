...
metadata = {
    'protocolName': 'Shaur No HS Illumina DNA Enrichment',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # hs_adapter          = sample_plate_1.parent
...
############################################################################################################################################
    ...
    if STEP_CAPTURE == 1:
        ...
        p1000.dispense(TransferSup+5, sample_plate_1[sample_well].bottom(z=1))
        p1000.return_tip()
        ...
        p1000.dispense(SMBVol/2, sample_plate_1[sample_well].top(z=2), rate=0.25)
        p1000.aspirate(SMBVol/2, SMB.bottom(z=1), rate=0.25)
        p1000.dispense(SMBVol/2, sample_plate_1[sample_well].bottom(z=1), rate=0.25)
        p1000.default_speed = 5
        p1000.move_to(sample_plate_1[sample_well].bottom(z=5))
        for Mix in range(2):
            ...
            Mix += 1
        p1000.touch_tip()
        p1000.blow_out(sample_plate_1[sample_well].top(z=2))
        p1000.default_speed = 400
        p1000.move_to(sample_plate_1[sample_well].top(z=5))
        p1000.move_to(sample_plate_1[sample_well].top(z=0))
        p1000.move_to(sample_plate_1[sample_well].top(z=5))
        p1000.return_tip()
        #========NEW HS MIX=========================
        ...
        p1000.pick_up_tip()
        p1000.move_to(sample_plate_1[sample_well].bottom(4))
        ...
        #============================================================================================
        # GRIPPER MOVE sample_plate_1 FROM MAGPLATE TO heatershaker
        #heatershaker.open_labware_latch()
        protocol.move_labware(
            labware=sample_plate_1,
        ...
        for wash in range(washreps):
            ...
            p1000.dispense(EEWVol, sample_plate_1[sample_well].bottom())
            p1000.return_tip()
        ...
        sample_well = 'A4'
        p1000.dispense(TransferSup, sample_plate_1[sample_well].bottom(z=1))
        p1000.return_tip()
        ...
        p50.pick_up_tip()
        p50.move_to(sample_plate_1[sample_well].bottom(z=0))
        ...
        p50.dispense(EluteVol, sample_plate_1[sample_well].bottom())
        p50.return_tip()
    ...
    if STEP_CLEANUP == 1:
        ...
        p1000.dispense(AMPureVol, sample_plate_1[sample_well].bottom(z=1), rate=0.25)
        p1000.default_speed = 5
        p1000.move_to(sample_plate_1[sample_well].bottom(z=5))
        for Mix in range(2):
       ...
       # heatershaker.close_labware_latch()
        ...
        p1000.pick_up_tip()
        p1000.move_to(sample_plate_1[sample_well].bottom(z=0))
        ...
        p1000.move_to((sample_plate_1.wells_by_name()[sample_well].center().move(types.Point(x=1.3*0.8,y=0,z=-4))))
        p1000.dispense(RSBVol, rate=1)
        p1000.move_to(sample_plate_1.wells_by_name()[sample_well].bottom(z=1))
        p1000.aspirate(RSBVol, rate=1)
        p1000.move_to((sample_plate_1.wells_by_name()[sample_well].center().move(types.Point(x=0,y=1.3*0.8,z=-4))))
        p1000.dispense(RSBVol, rate=1)
        p1000.move_to(sample_plate_1.wells_by_name()[sample_well].bottom(z=1))
        p1000.aspirate(RSBVol, rate=1)
        p1000.move_to((sample_plate_1.wells_by_name()[sample_well].center().move(types.Point(x=1.3*-0.8,y=0,z=-4))))
        ...
        p1000.touch_tip()
        p1000.blow_out(sample_plate_1.wells_by_name()[sample_well].center())
        p1000.move_to(sample_plate_1.wells_by_name()[sample_well].top(z=5))
        p1000.move_to(sample_plate_1.wells_by_name()[sample_well].top(z=0))
        p1000.move_to(sample_plate_1.wells_by_name()[sample_well].top(z=5))
        p1000.return_tip()
        #heatershaker.set_and_wait_for_shake_speed(rpm=1600)
        ...
        p1000.move_to(sample_plate_1[sample_well].bottom(z=0.25))
        p1000.aspirate(TransferSup+1, rate=0.25)
        p1000.dispense(TransferSup+5, sample_plate_1['A7'].bottom(z=1))
        p1000.return_tip()
