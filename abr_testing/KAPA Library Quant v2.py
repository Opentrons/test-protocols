    ...
    for repeat in range(6):
        ...
        if STEP_DISPENSE == 1:
            if FORMAT == '96':
                ...
                p50.dispense(20, qpcrplate_1[Y1].bottom(z=p50_offset_Mag), rate=0.5)
                p50.dispense(20, qpcrplate_1[Y2].bottom(z=p50_offset_Mag), rate=0.5)
                p50.dispense(10, qpcrplate_1[Y3].bottom(z=p50_offset_Mag), rate=0.5)
                p50.drop_tip() if DRYRUN == 'NO' else p50.return_tip()
                if samplecolumns >= 1:#-----------------------------------------------------------------------------------------
                    X = 'A10'
                    Y1 = 'A4'
                    ...
                    Y3 = 'A6' 
                    p50.pick_up_tip()
                    p50.aspirate(50, dilution_plate_1[X].bottom(z=p50_offset_Temp), rate=0.5)
                    p50.dispense(20, qpcrplate_1[Y1].bottom(z=p50_offset_Mag), rate=0.5)
                    p50.dispense(20, qpcrplate_1[Y2].bottom(z=p50_offset_Mag), rate=0.5)
                    p50.dispense(10, qpcrplate_1[Y3].bottom(z=p50_offset_Mag), rate=0.5)
                    p50.drop_tip() if DRYRUN == 'NO' else p50.return_tip()
            ...
            if FORMAT == '384':
                ...
                p50.mix(30,58)
                p50.aspirate(62, dilution_plate_1[X].bottom(z=p50_offset_Temp), rate=0.25)
                ...
                if samplecolumns >= 1:#-----------------------------------------------------------------------------------------
                    ...
                    p50.move_to(dilution_plate_1[X].bottom(z=p50_offset_Temp))
                    p50.mix(30,58)
                    p50.aspirate(62, dilution_plate_1[X].bottom(z=p1000_offset_Temp), rate=0.25)
                    protocol.delay(seconds=0.2)
                    p50.move_to(qpcrplate_1[Y1].top(z=1.0))
                    protocol.delay(seconds=0.2)
                    p50.default_speed = 2.5
                ...
                p50.mix(30,50)
                p50.aspirate(50, dilution_plate_2[X].bottom(z=p50_offset_Temp), rate=0.25)
                protocol.delay(seconds=0.2)
                p50.move_to(qpcrplate_2[Y1].top(z=1.0))
                protocol.delay(seconds=0.2)
                p50.default_speed = 2.5
                p50.dispense(10, qpcrplate_2[Y1].bottom(z=1.75), rate=0.25)
                protocol.delay(seconds=0.2)
                p50.default_speed = 400
                p50.move_to(qpcrplate_2[Y2].top(z=1.0))
                protocol.delay(seconds=0.2)
                p50.default_speed = 2.5
                p50.dispense(10, qpcrplate_2[Y2].bottom(z=1.75), rate=0.25)
                protocol.delay(seconds=0.2)
                p50.default_speed = 400
                p50.move_to(qpcrplate_2[Y3].top(z=1.0))
                protocol.delay(seconds=0.2)
                p50.default_speed = 2.5
                p50.dispense(10, qpcrplate_2[Y3].bottom(z=1.75), rate=0.25)
                protocol.delay(seconds=0.2)
                p50.default_speed = 400
                ...
                protocol.delay(seconds=0.2)
                p50.default_speed = 2.5
                p50.dispense(10, qpcrplate_2[Y4].bottom(z=1.75), rate=0.25)
                protocol.delay(seconds=0.2)
                p50.default_speed = 400
                p50.move_to(qpcrplate_2[Y5].top(z=1.0))
                protocol.delay(seconds=0.2)
                p50.default_speed = 2.5
                p50.dispense(10, qpcrplate_2[Y5].bottom(z=1.75), rate=0.25)
                protocol.delay(seconds=0.2)
                p50.default_speed = 400
                p50.move_to(qpcrplate_2[Y6].top(z=1.0))
                protocol.delay(seconds=0.2)
                p50.default_speed = 2.5
                p50.dispense(10, qpcrplate_2[Y6].bottom(z=1.75), rate=0.25)
                protocol.delay(seconds=0.2)
                p50.default_speed = 400
