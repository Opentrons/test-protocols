...
def run(ctx):
    ...
    tiprack1= ctx.load_labware_by_name('opentrons_96_tiprack_1000ul', 6)
...
o
    ...
    #pipettes
    pip1= ctx.load_instrument('p1000_single_gen2','right', tip_racks=[tiprack1])
    pip2 = ctx.load_instrument('p20_single_gen2','left', tip_racks=[tiprack])
