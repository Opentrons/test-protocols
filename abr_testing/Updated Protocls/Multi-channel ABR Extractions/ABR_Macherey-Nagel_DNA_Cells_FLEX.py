...
metadata = {
    'protocolName': 'Flex Macherey-Nagel Nucleomag DNA Extraction: Tissue, Cells, Bacteria- ABR',
...
Slot C3: Tips 1000
Slot D1: H-S with Macherey-Nagel 96 Well Deepwell and universal flat Adapter
Slot D2: Nest 12 well 15 ml Reservoir
Slot D3: Temperature module (gen2) with 96 well PCR block and Armadillo 96 well PCR Plate
...
def run(ctx):
    ...
    temp_block = temp.load_adapter('opentrons_96_aluminumblock')
    elutionplate = temp_block.load_labware('nest_96_wellplate_100ul_pcr_full_skirt')
