...
def run(protocol: protocol_api.ProtocolContext):
    ...
    tiprack_200_1       = protocol.load_labware('opentrons_flex _96_tiprack_200ul', '5')
    tiprack_50_1        = protocol.load_labware('opentrons_flex _96_tiprack_50ul', '6')
    # ========== THIRD ROW ===========
    thermocycler        = protocol.load_module('thermocycler module gen2')
    tiprack_200_2       = protocol.load_labware('opentrons_flex _96_tiprack_200ul', '8')
    tiprack_50_2        = protocol.load_labware('opentrons_flex _96_tiprack_50ul', '9')
    # ========== FOURTH ROW ==========
    tiprack_200_3       = protocol.load_labware('opentrons_flex _96_tiprack_200ul', '11')
