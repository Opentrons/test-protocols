...
def run(protocol: protocol_api.ProtocolContext):
    ...
    heat_shake = protocol.load_labware('heaterShakerModuleV1', 'D1')
    plate = heat_shake.load_labware('nest_96_wellplate_100ul_pcr_full_skirt')
    temp_deck = protocol.load_labware('temperature module gen2', 'D3')
    ...
    protocol.move_labware(
        ...
        drop_offset=grip_offset("drop", "heater-shakers", 1),
    )
