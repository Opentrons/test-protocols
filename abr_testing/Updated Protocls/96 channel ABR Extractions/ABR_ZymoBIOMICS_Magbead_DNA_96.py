...
metadata = {
    'protocolName': 'Flex ZymoBIOMICS Magbead DNA Extraction: Cells or Bacteria 96 channel ABR',
...
Slot B1: Nest 96 Deep Well (wash1 reservoir-600 ul  each well)
Slot B2: Nest 96 Deep Well (wash2-3 reservoir-1900 ul  each well)
Slot B3: Nest 96 Deep Well (wash4 reservoir-1000 ul  each well)
Slot C1: Magblock
Slot C2: Nest 96 Deep Well (Beads and Bind reservoir- 725 ul each well)
Slot C3: Nest 96 Deep Well (Second bind reservoir-600 ul each well)
Slot D1: H-S with Nest 96 Deep Well
Slot D2: Nest 96 Deep Well (Lysis reservoir-320 ul each well)
Slot D3: Temperature module (gen2) with 96 well PCR block and Armadillo 96 well PCR Plate (75 ul 
each well)
"""
