...
############################################################################################################################################
    ...
    if STEP_FRERAT == 1:
        ...
        p1000.aspirate(FRERATVol, FRERAT.bottom(z=.6)) #original = ()
        p1000.dispense(FRERATVol, sample_plate_1['A1'].bottom(z=.6)) #original = ()
        p1000.move_to(sample_plate_1['A1'].bottom(z=.6)) #original = ()
    ...
    if STEP_LIG == 1:
        ...
        p1000.dispense(LIGVol, sample_plate_1['A1'].bottom(z=.6), rate=0.25) #original = ()
        p1000.move_to(sample_plate_1['A1'].bottom(z=.6)) #original = ()
    ...
    if STEP_CLEANUP == 1:
        ...
        p1000.move_to(sample_plate_1['A1'].bottom(z=.6)) #original = .5
        ...
        p1000.pick_up_tip(tiprack_200_1['A1']) #<---------------- Tip Pickup
        p1000.move_to(sample_plate_1['A1'].bottom(z=.6)) #original = (z=0)
        ...
        TransferSup = 20
        p1000.pick_up_tip(tiprack_20_1['A1']) #<---------------- Tip Pickup
        p1000.move_to(sample_plate_1['A1'].bottom(z=.6)) #original = .25
    ...
    if STEP_POSTPCR == 1:
        ...
        p1000.aspirate(RemoveSup-100, rate=0.25)
        protocol.delay(minutes=0.1)
        p1000.move_to(sample_plate_2['A1'].bottom(z=.6)) #original = .5
        p1000.aspirate(100, rate=0.25)
        p1000.default_speed = 5
        ...
        protocol.comment('--> Removing Residual ETOH')
        p1000.pick_up_tip(tiprack_200_1['A1']) #<---------------- Tip Pickup
        p1000.move_to(sample_plate_2['A1'].bottom(z=.6)) #original = (z=0)
        p1000.aspirate(50, rate=0.25)
        p1000.default_speed = 200
        p1000.dispense(100, Liquid_trash.top(z=0))
        protocol.delay(minutes=0.1)
        ...
        TransferSup = 20
        p1000.pick_up_tip(tiprack_20_1['A1']) #<---------------- Tip Pickup
        p1000.move_to(sample_plate_2['A1'].bottom(z=.6)) #original = .25
        p1000.aspirate(TransferSup+1, rate=0.25)
